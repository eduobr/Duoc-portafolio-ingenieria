      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            <a href="#" class="small mr-3"><span class="icon-question-circle-o mr-2"></span>¿Alguna pregunta?</a> 
            <a href="#" class="small mr-3"><span class="icon-phone2 mr-2"></span> 02 2222 5555 </a> 
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="register.jsp" >Crear Check-List</a></li>
                    <li><a href="crearMejora.jsp" >Crear mejora</a></li>
                ...
                <li class="has-children">
                  <a href="Cliente.jsp" class="nav-link text-left">Clientes</a>
                   <ul class="dropdown">
                    <li><a href="Evento.jsp">Notificar evento</a></li>
        ...
        <div class="row mb-5 justify-content-center text-center">
          <div class="col-lg-4 mb-5">
            <h2 class="section-title-underline mb-5">
              <span>No Más Accidentes puede ayudarte</span>
            </h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Planes para tu empresa</h2>
                <p>Lista personalizadas de revisiones para tu empresa sin importar el rubro de ella. </p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Asesorias</h2>
                <p> Asesorias para los inconvenientes que se pueden presentar en tu empresa. </p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Visitas de Profesionales</h2>
                <p>Visitas de Profesionales a tu empresa, en las cuales te daran tips para mejorar tu empresa.</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <p class="lead">
                Nuestra empresa se especializa en las auditorias sobre seguridad en diferentes rubros, además de asesorarte para tomar las desiciones correctas cuando lo necesites en caso de accidentes o fiscalizaciones. 
            </p>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url('images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
            <h2>Escribenos</h2>
            <p>Para más información envianos un e-mail para que uno de nuestros administradores se ponga en contacto con usted.</p>
          </div>
          <div class="col-lg-5">
            <form action="" class="d-flex">
              <input type="text" class="rounded form-control mr-2 py-3" placeholder="Ingrese su email">
              <button class="btn btn-primary rounded py-3 px-4" type="submit">Enviar</button>
            </form>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            ...
            <p>La empresa No más accidentes esta para ayudarte y orientarte cuando lo necesites.</p>  
            
          </div>
          <div class="col-lg-3">
              <center>
              <h3   class="footer-heading"  ><span ><a href="about.jsp"> Sobre nosotros</a> </span></h3>
            <ul class="list-unstyled">
                <li><a href="Cliente.jsp">Cliente</a></li>
                <li><a href="Profesional.jsp">Profesional</a></li>
                <li><a href="Asesoria.jsp">Asesoria</a></li>
          ...
          <div class="col-lg-3">
              <center>
              <h3 class="nav-link text-center footer-heading"><span>Nuestros servicios</span></h3>
              <ul class="list-unstyled">
                  <li>Asesorias</li>
                  <li>Capacitaciones</li>
                  <li>Visitas Programadas</li>
                  <li>Check-list Personalizados</li>
              </ul>
              </center>
          </div>
          <div class="col-lg-3">
              <center>
              <h3 class="nav-link text-center footer-heading"><span>Contactos</span></h3>
              <ul class="list-unstyled">
                  <li>Correo: nmaccidentes@gmail.com</li>
                  <li>Telefono fijo:   2222 3333</li>
                  <li>Telefono Cel: 02 2345 6789</li>
