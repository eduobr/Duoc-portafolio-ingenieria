...
namespace DALC_01.controller
{
    public class ClienteController
    {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        item.nombre = dr["NOMBRE"].ToString()+" "+dr["APEPATERNO"].ToString()+" "+dr["APEMATERNO"].ToString();
        ...
        public int Insert_Cliente(string rutCliente, string nombre, string apePaterno, string apeMaterno, string direccion, string email, string telefono, int idComuna, int idRubro, int idUsuario, string empresa)
        {
            try
            {
                ...
                parameter[7] = idComuna;
                parameter[8] = idRubro;
                parameter[9] = idUsuario;
                parameter[10] = empresa.ToString();
