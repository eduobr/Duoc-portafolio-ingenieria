    ...
    public class ProfesionalController
    {
        ...
        public List<Profesional> buscarProfesional(string param)
        {
            ...
            try
            {
                ...
                Oracle.DataAccess.Client.OracleCommand cmd = operaciones.execSP("PKG_PROFESIONAL.BUSCAR_PROFESIONAL_ESC", parametro);
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        profecional.nombre = dr["NOMBRE"].ToString() + " " + dr["APEPATERNO"].ToString() + " " + dr["APEMATERNO"].ToString();
        ...
        public int Insert_Profecional(string rutProfesional, string nombre, string apePaterno, string apeMaterno, string telefono, DateTime fechaNacimientoPro, int idComuna, int idUsuario)
        {
            ...
            parameter[5] = fechaNacimientoPro;
            parameter[6] = idComuna;
            parameter[7] = idUsuario;
