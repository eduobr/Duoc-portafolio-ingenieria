...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDBOLETA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 22 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDCHECKLIST"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 102 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDCLIENTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 63 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDEVENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 63 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDMODIFICACIONCHECK
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDMODIFICACIONCHECK"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 63 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDPLANCONTRATADO
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDPLANCONTRATADO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 43 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDPROFESIONAL
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDPROFESIONAL"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 82 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence IDREPORTECLI
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDREPORTECLI"  MINVALUE 1 MAXVALUE 9999999999999999999999 INCREMENT BY 1 START WITH 5 CACHE 2 NOORDER  CYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDREPORTEGLO
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDREPORTEGLO"  MINVALUE 1 MAXVALUE 9999999999999999999999 INCREMENT BY 1 START WITH 3 CACHE 2 NOORDER  CYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDUSUARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 104 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence IDVISITA
--------------------------------------------------------

   CREATE SEQUENCE  "NOMAS"."IDVISITA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 102 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "NOMAS"."REPORTECLIENTE" 
   (	"IDREPORTE" NUMBER, 
	"VISITAS" NUMBER, 
	...
	"NOMBRECLI" VARCHAR2(100 BYTE), 
	"EMPRESA" VARCHAR2(100 BYTE), 
	"RUTPROF" VARCHAR2(20 BYTE), 
	"NOMBREPROF" VARCHAR2(100 BYTE), 
	"IDCLIENTE" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "NOMAS"."REPORTEGLOBAL" 
   (	"IDREPORTE" NUMBER, 
...
SET DEFINE OFF;
Insert into NOMAS.BOLETA (IDBOLETA,FECPAGO,FECLIMITE,MONTO,ESTADOBOLETA,IDPLAN) values ('100',to_date('15/12/19','DD/MM/RR'),to_date('20/12/19','DD/MM/RR'),'300000','1','23');
Insert into NOMAS.BOLETA (IDBOLETA,FECPAGO,FECLIMITE,MONTO,ESTADOBOLETA,IDPLAN) values ('1',to_date('10/12/19','DD/MM/RR'),to_date('15/12/19','DD/MM/RR'),'300000','1','23');
Insert into NOMAS.BOLETA (IDBOLETA,FECPAGO,FECLIMITE,MONTO,ESTADOBOLETA,IDPLAN) values ('2',to_date('15/01/20','DD/MM/RR'),to_date('20/01/20','DD/MM/RR'),'300000','0','23');
REM INSERTING into NOMAS.CAPACITACION
SET DEFINE OFF;
REM INSERTING into NOMAS.CHECKLIST
SET DEFINE OFF;
Insert into NOMAS.CHECKLIST (IDCHECK,DESCRIPCION,IDPLAN) values ('88','Revisar Cables Electronicos','23');
Insert into NOMAS.CHECKLIST (IDCHECK,DESCRIPCION,IDPLAN) values ('86','Revisar Camaras Frio','23');
Insert into NOMAS.CHECKLIST (IDCHECK,DESCRIPCION,IDPLAN) values ('87','Revisar Seguridad','23');
REM INSERTING into NOMAS.CHECKLISTREPORTE
SET DEFINE OFF;
REM INSERTING into NOMAS.CIUDAD
SET DEFINE OFF;
Insert into NOMAS.CIUDAD (IDCIUDAD,DESCRIPCION) values ('1','Santiago');
REM INSERTING into NOMAS.CLIENTE
SET DEFINE OFF;
Insert into NOMAS.CLIENTE (IDCLIENTE,RUT,NOMBRE,APEPATERNO,APEMATERNO,DIRECCION,EMAIL,TELEFONO,IDCOMUNA,IDRUBRO,IDUSUARIO,EMPRESA) values ('23','10610975-3','Pedro','Sanchez','Rivera','Los Aromos 551','pe.sa@hotmail.com','+56924564231','13','1','51','Walmart');
Insert into NOMAS.CLIENTE (IDCLIENTE,RUT,NOMBRE,APEPATERNO,APEMATERNO,DIRECCION,EMAIL,TELEFONO,IDCOMUNA,IDRUBRO,IDUSUARIO,EMPRESA) values ('44','13133198-3','Pablo','Zamorano','Salas','granada 123','pa@hotmail.com','+56953252312','1','1','85','Transantiago');
REM INSERTING into NOMAS.COMUNA
SET DEFINE OFF;
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('1','Cerrillos','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('2','La Reina','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('3','Pudahuel','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('4','Cerro Navia','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('5','Las Condes','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('6','Quilicura','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('7','Conchalí','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('8','Lo Barnechea','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('9','Quinta Normal','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('10','El Bosque','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('11','Lo Espejo','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('12','Recoleta','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('13','Estación Central','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('14','Lo Prado','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('15','Renca','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('16','Huechuraba','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('17','Macul','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('18','San Miguel','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('19','Independencia','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('20','Maipú','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('21','San Joaquín','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('22','La Cisterna','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('23','Ñuñoa','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('24','San Ramón','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('25','La Florida','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('26','Pedro Aguirre Cerda','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('27','Santiago','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('28','La Pintana','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('29','Peñalolén','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('30','Vitacura','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('31','La Granja','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('32','Providencia','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('33','Colina','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('34','Peñaflor','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('35','San Bernardo','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('36','Lampa','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('37','Pirque','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('38','San José de Maipo','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('39','Padre Hurtado','1');
Insert into NOMAS.COMUNA (IDCOMUNA,DESCRIPCION,IDCIUDAD) values ('40','Puente Alto','1');
REM INSERTING into NOMAS.DETALLEBOLETA
SET DEFINE OFF;
REM INSERTING into NOMAS.EVENTO
SET DEFINE OFF;
Insert into NOMAS.EVENTO (IDEVENTO,DESCRIPCION,ASESORIA,FECHA,IDTIPOEVENTO,IDPLAN) values ('48','Se me accidento un trabajador','llevelo a la mutual de trabajadores',to_date('06/12/19','DD/MM/RR'),'1','23');
REM INSERTING into NOMAS.MODIFICACIONCHECK
SET DEFINE OFF;
Insert into NOMAS.MODIFICACIONCHECK (IDMODIFICACION,FECHA,IDCHECK) values ('43',to_date('05/12/19','DD/MM/RR'),'88');
REM INSERTING into NOMAS.PLANCONTRATADO
SET DEFINE OFF;
Insert into NOMAS.PLANCONTRATADO (IDPLAN,FECPLAN,PRECIO,ESTADO,IDCLIENTE,IDPROFESIONAL) values ('23',to_date('05/12/19','DD/MM/RR'),'500000','1','23','42');
REM INSERTING into NOMAS.PROFESIONAL
SET DEFINE OFF;
Insert into NOMAS.PROFESIONAL (IDPROFESIONAL,RUT,NOMBRE,APEPATERNO,APEMATERNO,TELEFONO,FECNACIMIENTO,IDCOMUNA,IDUSUARIO) values ('42','19025420-8','Eduardo','Obreque','Hevia','+56957424232',to_date('12/04/19','DD/MM/RR'),'40','48');
Insert into NOMAS.PROFESIONAL (IDPROFESIONAL,RUT,NOMBRE,APEPATERNO,APEMATERNO,TELEFONO,FECNACIMIENTO,IDCOMUNA,IDUSUARIO) values ('62','9904324-5','Charles','Aranguiz','Soto','+56998734678',to_date('13/07/95','DD/MM/RR'),'22','65');
REM INSERTING into NOMAS.REPORTECLIENTE
SET DEFINE OFF;
Insert into NOMAS.REPORTECLIENTE (IDREPORTE,VISITAS,CAPACITACIONES,ACCIDENTES,MULTAS,FECHA,RUTCLI,NOMBRECLI,EMPRESA,RUTPROF,NOMBREPROF,IDCLIENTE) values ('3','2','0','0','0',to_date('05/12/19','DD/MM/RR'),'10610975-3','Pedro Sanchez','Walmart','19025420-8','Eduardo Obreque','23');
REM INSERTING into NOMAS.REPORTEGLOBAL
SET DEFINE OFF;
Insert into NOMAS.REPORTEGLOBAL (IDREPORTE,PLANES_ACTIVOS,PLANES_INACTIVOS,CANTIDAD_CLIENTES,CANTIDAD_PROFESIONALES,FECHA,IDUSU_ADM) values ('1','1','0','1','2',to_date('05/12/19','DD/MM/RR'),'1');
Insert into NOMAS.REPORTEGLOBAL (IDREPORTE,PLANES_ACTIVOS,PLANES_INACTIVOS,CANTIDAD_CLIENTES,CANTIDAD_PROFESIONALES,FECHA,IDUSU_ADM) values ('2','1','0','1','2',to_date('05/12/19','DD/MM/RR'),'1');
REM INSERTING into NOMAS.RUBRO
SET DEFINE OFF;
Insert into NOMAS.RUBRO (IDRUBRO,DESCRIPCION) values ('1','Construccion');
Insert into NOMAS.RUBRO (IDRUBRO,DESCRIPCION) values ('2','Mineria');
Insert into NOMAS.RUBRO (IDRUBRO,DESCRIPCION) values ('3','Comercio');
Insert into NOMAS.RUBRO (IDRUBRO,DESCRIPCION) values ('4','Medicina');
Insert into NOMAS.RUBRO (IDRUBRO,DESCRIPCION) values ('5','Transporte');
...
SET DEFINE OFF;
Insert into NOMAS.USUARIO (IDUSUARIO,USU,PASS,ESTADOUSUARIO,IDTIPOUSUARIO) values ('1','admin','123','1','1');
Insert into NOMAS.USUARIO (IDUSUARIO,USU,PASS,ESTADOUSUARIO,IDTIPOUSUARIO) values ('65','charl','123','1','3');
Insert into NOMAS.USUARIO (IDUSUARIO,USU,PASS,ESTADOUSUARIO,IDTIPOUSUARIO) values ('48','edd123','123','1','3');
Insert into NOMAS.USUARIO (IDUSUARIO,USU,PASS,ESTADOUSUARIO,IDTIPOUSUARIO) values ('51','pedro123','123','1','2');
Insert into NOMAS.USUARIO (IDUSUARIO,USU,PASS,ESTADOUSUARIO,IDTIPOUSUARIO) values ('85','pablo','pablo123','1','2');
REM INSERTING into NOMAS.VISITA
SET DEFINE OFF;
Insert into NOMAS.VISITA (IDVISITA,FECHA,IDPLAN,IDESTADO) values ('82',to_date('12/12/19','DD/MM/RR'),'23','0');
Insert into NOMAS.VISITA (IDVISITA,FECHA,IDPLAN,IDESTADO) values ('83',to_date('20/12/19','DD/MM/RR'),'23','0');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index REPORTEC_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "NOMAS"."REPORTEC_PK" ON "NOMAS"."REPORTECLIENTE" ("IDREPORTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index REPORTEG_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "NOMAS"."REPORTEG_PK" ON "NOMAS"."REPORTEGLOBAL" ("IDREPORTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
PROCEDURE LISTAR_NO_PAGADOS(c_boleta OUT T_CURSOR_BOLETA);
PROCEDURE NOTIFICAR_ATRASO(idBoleta_c NUMBER);
PROCEDURE QUITAR_SERVICIO(idPlan_c NUMBER);
PROCEDURE RESTABLECER_SERVICIO(idPlan_c NUMBER);
PROCEDURE LISTAR_BOLETAS_CLI(idPlan_c NUMBER, c_boleta OUT T_CURSOR_BOLETA);
PROCEDURE PAGAR_BOLETA(idBoleta_c NUMBER);
END PKG_BOLETA;
...
PROCEDURE BUSCAR_CAPACITACION_ESC(parametro VARCHAR2, c_capacitacion OUT T_CURSOR_CAPACITACION);
...
PROCEDURE BUSCAR_CHECKLIST_ADM(rutCliente_c VARCHAR2,c_checklist OUT T_CURSOR_CHECKLIST);
END PKG_CHECKLIST;
...
PROCEDURE INSERTAR_CLIENTE(rut_c VARCHAR2,nombre_c VARCHAR2,apePaterno_c VARCHAR2,apeMaterno_c VARCHAR2,direccion_c VARCHAR2,email_c VARCHAR2,telefono_c VARCHAR2,idComuna_c NUMBER,idRubro_c NUMBER,idUsuario_c NUMBER,empresa_c VARCHAR2);
PROCEDURE MODIFICAR_CLIENTE(idCliente_c NUMBER,rut_c VARCHAR2,nombre_c VARCHAR2,apePaterno_c VARCHAR2,apeMaterno_c VARCHAR2,direccion_c VARCHAR2,email_c VARCHAR2,telefono_c VARCHAR2,idComuna_c NUMBER,idRubro_c NUMBER,idUsuario_c NUMBER, empresa_c VARCHAR2);
...
PROCEDURE LISTAR_ACCIDENTES(c_accidente OUT T_CURSOR_EVENTO);
PROCEDURE BUSCAR_ACCIDENTES(parametro VARCHAR2, c_accidente OUT T_CURSOR_EVENTO);
PROCEDURE CONTAR_EVENTOS_PROF(idProfesional_c NUMBER, cuenta OUT NUMBER);
PROCEDURE LISTAR_EVENTOS_PROF(idProfesional_c NUMBER, c_eventos OUT T_CURSOR_EVENTO);
PROCEDURE RESPONDER_EVENTO(idEvento_c NUMBER,respuesta VARCHAR2);
END PKG_EVENTO;
...
PROCEDURE INSERTAR_PLANCONTRATADO(precio_c NUMBER,rutCliente_c VARCHAR2,rutProfesional_c VARCHAR2,fecVisita_c DATE, fecVisita2_c DATE);
PROCEDURE MODIFICAR_PLANCONTRATADO(idPlan_c NUMBER,fecPlan_c DATE,precio_c NUMBER,estado_c NUMBER,idCliente_c NUMBER,idProfesional_c NUMBER);
...
PROCEDURE BUSCAR_PLANCONTRATADO(parametro VARCHAR2,c_plancontratado OUT T_CURSOR_PLANCONTRATADO);
...
PROCEDURE OBTENER_PLAN_PROF_USR(idProfesional_c NUMBER, c_plancontratado OUT T_CURSOR_PLANCONTRATADO);
...
PROCEDURE BUSCAR_PROFESIONAL_ESC(parametro VARCHAR2,c_profesional OUT T_CURSOR_PROFESIONAL);
END PKG_PROFESIONAL;
...
PROCEDURE INGRESAR_REPORTE_CLIENTE(idCliente_c NUMBER);
PROCEDURE INGRESAR_REPORTE_GLOBAL(idUsuario_c NUMBER);
PROCEDURE LISTAR_REPORTE_CLIENTE(c_reporte OUT T_CURSOR_REPORTE);
PROCEDURE LISTAR_GLOBAL(c_reporte OUT T_CURSOR_REPORTE);
END PKG_REPORTE;
...
PROCEDURE BUSCAR_VISITA(parametro VARCHAR2, c_visita OUT T_CURSOR_VISITA);
END PKG_VISITA;
...
BEGIN
	OPEN c_boleta FOR
		SELECT bo.idboleta,cl.rut,cl.nombre||' '||cl.apepaterno AS "NOMBRE CLIENTE"
		,bo.feclimite,bo.estadoboleta,bo.idplan,pc.estado FROM BOLETA bo
		INNER JOIN PLANCONTRATADO pc ON pc.idplan = bo.idplan
		INNER JOIN CLIENTE cl ON pc.idcliente = cl.idcliente
		WHERE ESTADOBOLETA=0 OR ESTADOBOLETA=3;
...
IS
BEGIN
	UPDATE BOLETA SET ESTADOBOLETA=3 WHERE idBoleta = idBoleta_c;
END;

PROCEDURE QUITAR_SERVICIO(idPlan_c NUMBER)
IS
BEGIN
	UPDATE PLANCONTRATADO SET ESTADO=0 WHERE IDPLAN=idPlan_c;
END;

PROCEDURE RESTABLECER_SERVICIO(idPlan_c NUMBER)
IS
BEGIN
	UPDATE PLANCONTRATADO SET ESTADO=1 WHERE IDPLAN=idPlan_c;
END;
...
BEGIN
    OPEN c_boleta FOR
    SELECT * FROM BOLETA where IDPLAN=idPlan_c;
END;
...
IS
    ...
    V_FECLIMITE DATE;
BEGIN
    UPDATE BOLETA SET ESTADOBOLETA=1 WHERE IDBOLETA=idBoleta_c;
    SELECT IDPLAN,MONTO,FECPAGO,FECLIMITE INTO V_IDPLAN,V_PRECIO,V_FECPAGO,V_FECLIMITE FROM BOLETA WHERE IDBOLETA=idBoleta_c;
    INSERT INTO BOLETA VALUES(IDBOLETA.NEXTVAL,ADD_MONTHS(V_FECPAGO,1),ADD_MONTHS(V_FECLIMITE,1),V_PRECIO,0,V_IDPLAN);
END;
...
BEGIN
  OPEN c_capacitacion FOR
    SELECT c.*,pr.rut "RUT PROFESIONAL",cl.rut "RUT CLIENTE" FROM CAPACITACION c
	INNER JOIN PLANCONTRATADO pc ON c.idplan=pc.idplan
	INNER JOIN CLIENTE cl ON pc.idcliente=cl.idcliente
	INNER JOIN PROFESIONAL pr ON pc.idprofesional=pr.idprofesional;
END;
...
BEGIN
	...
	INNER JOIN CLIENTE cl ON pc.idcliente=cl.idcliente
	INNER JOIN PROFESIONAL pr ON pc.idprofesional=pr.idprofesional
	WHERE LOWER(cl.rut) LIKE '%'||parametro||'%' OR LOWER(pr.RUT) LIKE '%'||parametro||'%' OR LOWER(c.descripcion) LIKE '%'||parametro||'%' OR LOWER(c.FECHA) LIKE '%'||parametro||'%';
END;
...
BEGIN
	OPEN c_checklist FOR
		SELECT ROWNUM,DESCRIPCION FROM CHECKLIST ch 
		INNER JOIN PLANCONTRATADO pc ON pc.idplan=ch.idplan 
		INNER JOIN CLIENTE cl ON cl.idcliente=pc.idcliente
		WHERE cl.rut=rutCliente_c;
END;
...
IS
BEGIN
INSERT INTO CLIENTE VALUES (IDCLIENTE.NEXTVAL,rut_c,nombre_c,apePaterno_c,apeMaterno_c,direccion_c,email_c,telefono_c,idComuna_c,idRubro_c,idUsuario_c,empresa_c);
COMMIT;
EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
...
IS
BEGIN
	OPEN c_accidente FOR
		SELECT cl.rut,cl.nombre||' '||cl.apepaterno,pr.rut,pr.nombre||' '||pr.apepaterno,COUNT(IDEVENTO) AS "CANt ACC" FROM EVENTO ev
		INNER JOIN PLANCONTRATADO pc ON pc.idplan=ev.idplan
		INNER JOIN CLIENTE cl ON cl.idcliente=pc.idcliente
		INNER JOIN PROFESIONAL pr ON pr.idprofesional=pc.idprofesional
		WHERE IDTIPOEVENTO=1
		GROUP BY IDTIPOEVENTO,cl.rut,cl.nombre,cl.apepaterno,pr.rut,pr.nombre,pr.apepaterno;
END;
...
IS
    V_CUENTA NUMBER;
BEGIN
    SELECT COUNT(*) INTO V_CUENTA FROM EVENTO ev
    INNER JOIN PLANCONTRATADO pc ON ev.idplan = pc.idplan
    WHERE ASESORIA IS NULL AND pc.idProfesional=idProfesional_c;
    cuenta:=V_CUENTA;
END;
...
BEGIN
    OPEN c_eventos FOR
        SELECT cl.rut,cl.nombre||' '||cl.apepaterno,ev.idevento,ev.DESCRIPCION,tp.descripcion AS TIPO,NVL(ev.ASESORIA,' ') AS RESPUESTA,TO_CHAR(ev.FECHA,'dd/MM/yyyy HH:mm') AS FECHA  FROM EVENTO ev
        INNER JOIN TIPOEVENTO tp ON tp.IDTIPOEVENTO = ev.IDTIPOEVENTO
        INNER JOIN PLANCONTRATADO pc ON ev.idplan = pc.idplan
        INNER JOIN CLIENTE cl ON pc.idcliente = cl.idcliente 
        WHERE ASESORIA IS NULL AND pc.idProfesional=idProfesional_c;
END;
...
IS
BEGIN
    UPDATE EVENTO SET ASESORIA=respuesta WHERE idEvento = idEvento_c;
END;
END PKG_EVENTO;
...
INSERT INTO PLANCONTRATADO VALUES (V_IDPLAN,SYSDATE,precio_c,1,V_IDCLIENTE,V_IDPROFESIONAL);
...
INSERT INTO BOLETA VALUES(idboleta.NEXTVAL,ADD_MONTHS(SYSDATE,1),ADD_MONTHS(SYSDATE+5,1),precio_c,1,V_IDPLAN);
COMMIT;
...
BEGIN
  OPEN c_plancontratado FOR
    SELECT p.IDPLAN,c.NOMBRE||' '||c.APEPATERNO AS "NOMBRE CLIENTE",pro.NOMBRE||' '||pro.APEPATERNO AS "NOMBRE PROFESIONAL" ,
	TO_CHAR(p.fecplan,'DD/MM/YYYY') AS "FECPLAN",p.estado
	FROM PLANCONTRATADO p
	INNER JOIN CLIENTE c ON c.idcliente=p.idcliente
	INNER JOIN PROFESIONAL pro ON p.idprofesional=pro.idprofesional;
END;
...
BEGIN
  OPEN c_plancontratado FOR
	...
	INNER JOIN CLIENTE c ON c.idcliente=p.idcliente
	INNER JOIN PROFESIONAL pro ON p.idprofesional=pro.idprofesional
    WHERE LOWER(c.NOMBRE) LIKE '%'||parametro||'%' OR LOWER(c.APEPATERNO) LIKE '%'||parametro||'%'  OR LOWER(pro.NOMBRE) LIKE '%'||parametro||'%' OR LOWER(pro.APEPATERNO) LIKE '%'||parametro||'%' OR 
	LOWER(TO_CHAR(p.fecplan,'DD/MM/YYYY')) LIKE '%'||parametro||'%' OR LOWER(p.estado) LIKE '%'||parametro||'%';
END;
...
BEGIN
  OPEN c_plancontratado FOR
    SELECT pc.*,cl.rut,cl.nombre||' '||cl.apepaterno||' '||cl.apematerno AS "NOMBRE",cl.direccion FROM PLANCONTRATADO pc
    INNER JOIN CLIENTE cl ON cl.idcliente=pc.idcliente
...
BEGIN
	OPEN c_plancontratado FOR
		SELECT * FROM PLANCONTRATADO WHERE idProfesional = idProfesional_c;
END;
...
BEGIN
	OPEN c_profesional FOR
		SELECT * FROM PROFESIONAL 
		WHERE LOWER(rut) LIKE '%'||parametro||'%' OR LOWER(nombre) LIKE '%'||parametro||'%' OR LOWER(apepaterno) LIKE '%'||parametro||'%' 
		OR LOWER(apematerno) LIKE '%'||parametro||'%' OR LOWER(TELEFONO) LIKE '%'||parametro||'%';
END;
...
IS
    V_VISITAS NUMBER;
    V_CAPACITACIONES NUMBER;
    V_ACCIDENTES NUMBER;
    V_MULTAS NUMBER;
    V_RUTCLI VARCHAR2(20);
    V_NOMCLI VARCHAR2(100);
    V_EMPRESA VARCHAR2(100);
    V_RUTPROF VARCHAR2(20);
    V_NOMPROF VARCHAR2(100);
BEGIN
    SELECT COUNT(v.idvisita) "VISITAS",COUNT(ca.idcapacitacion) "CAPACITACIONES",
    NVL((case when ev.idtipoevento = 1 then Count(ev.idevento)end ),0) "ACCIDENTES", 
    NVL((case when ev.idtipoevento = 3 then Count(ev.idevento)end ),0) "MULTAS",
    cl.rut,cl.nombre||' '||cl.apepaterno,cl.empresa,
    pf.rut,pf.nombre||' '||pf.apepaterno
    INTO V_VISITAS,V_CAPACITACIONES,V_ACCIDENTES,V_MULTAS,V_RUTCLI,V_NOMCLI,V_EMPRESA,V_RUTPROF,V_NOMPROF
    FROM plancontratado pc
    INNER JOIN CLIENTE cl ON cl.idcliente = pc.idcliente
    INNER JOIN PROFESIONAL pf ON pc.idProfesional = pf.idprofesional
    INNER JOIN VISITA v ON pc.idplan = v.idplan
    LEFT JOIN CAPACITACION ca ON ca.idPlan = pc.idPlan
    LEFT JOIN EVENTO ev ON pc.idplan = ev.idplan
    WHERE cl.idcliente=idCliente_c
    GROUP BY cl.rut,cl.nombre,cl.apepaterno,pf.rut,pf.nombre,pf.apepaterno,cl.empresa,ev.idtipoevento,ev.idevento;

    INSERT INTO reportecliente VALUES(IDREPORTECLI.NEXTVAL,V_VISITAS,V_CAPACITACIONES,V_ACCIDENTES,V_MULTAS,SYSDATE,V_RUTCLI,V_NOMCLI,V_EMPRESA,V_RUTPROF,V_NOMPROF,idCliente_c);
END;
...
IS
    ...
    V_PINACTIVO NUMBER;
BEGIN
    SELECT COUNT(*) INTO V_CLI FROM CLIENTE;
    SELECT COUNT(*) INTO V_PROF FROM PROFESIONAL;
    SELECT NVL((case when estado = 1 then Count(idplan)end ),0) "PLANES ACTIVOS", 
    NVL((case when estado = 0 then Count(idplan)end ),0) "PLANES INACTIVOS" INTO V_PACTIVO,V_PINACTIVO FROM PLANCONTRATADO
    GROUP BY estado;
    INSERT INTO REPORTEGLOBAL VALUES(IDREPORTEGLO.nextval,V_PACTIVO,V_PINACTIVO,V_CLI,V_PROF,SYSDATE,idUsuario_c);
END;
...
INSERT INTO USUARIO VALUES (V_IDUSUARIO,user_c,pass_c,1,idTipoUsuario_c);
...
BEGIN
	OPEN c_visita FOR
		...
		INNER JOIN CLIENTE cl ON cl.IDCLIENTE = pl.IDCLIENTE
		INNER JOIN PROFESIONAL pf ON pf.IDPROFESIONAL=pl.IDPROFESIONAL
		WHERE LOWER(vi.IDVISITA) LIKE '%'||parametro||'%' OR  LOWER(TO_CHAR(vi.FECHA,'DD/MM/YYYY')) LIKE '%'||parametro||'%' OR LOWER(vi.IDESTADO) LIKE '%'||parametro||'%' OR LOWER(cl.RUT) LIKE '%'||parametro||'%' OR LOWER(pf.RUT) LIKE '%'||parametro||'%' OR LOWER(cl.nombre) LIKE '%'||parametro||'%' OR LOWER(cl.apepaterno) LIKE '%'||parametro||'%' OR 
		LOWER(pf.nombre) LIKE '%'||parametro||'%' OR LOWER(pf.apepaterno) LIKE '%'||parametro||'%';
END BUSCAR_VISITA;
...
--------------------------------------------------------
  ...
  ALTER TABLE "NOMAS"."REPORTECLIENTE" ADD CONSTRAINT "REPORTEC_PK" PRIMARY KEY ("IDREPORTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("IDCLIENTE" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("NOMBREPROF" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("RUTPROF" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("EMPRESA" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("NOMBRECLI" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("RUTCLI" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("MULTAS" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("ACCIDENTES" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("CAPACITACIONES" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("VISITAS" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTECLIENTE" MODIFY ("IDREPORTE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table REPORTEGLOBAL
--------------------------------------------------------

  ALTER TABLE "NOMAS"."REPORTEGLOBAL" ADD CONSTRAINT "REPORTEG_PK" PRIMARY KEY ("IDREPORTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("IDUSU_ADM" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("CANTIDAD_PROFESIONALES" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("CANTIDAD_CLIENTES" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("PLANES_INACTIVOS" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("PLANES_ACTIVOS" NOT NULL ENABLE);
  ALTER TABLE "NOMAS"."REPORTEGLOBAL" MODIFY ("IDREPORTE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "NOMAS"."REPORTECLIENTE" ADD CONSTRAINT "REPORTEC_CLIENTE_FK" FOREIGN KEY ("IDCLIENTE")
	  REFERENCES "NOMAS"."CLIENTE" ("IDCLIENTE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table REPORTEGLOBAL
--------------------------------------------------------

  ALTER TABLE "NOMAS"."REPORTEGLOBAL" ADD CONSTRAINT "REPORTEG_USUARIO_FK" FOREIGN KEY ("IDUSU_ADM")
	  REFERENCES "NOMAS"."USUARIO" ("IDUSUARIO") ENABLE;
--------------------------------------------------------
