    ...
    public class CheckListController
    {
        ...
        public List<CheckList> listarCheckList()
        {
            ...
            try
            {
                ...
                parametro[0] = "CHECKLIST";
                Oracle.DataAccess.Client.OracleCommand cmd = operaciones.execSP("PKG_CHECKLIST.LISTAR_CHECKLIST", parametro);
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        checkList.idCheck = int.Parse(dr["IDCHECK"].ToString());
                        checkList.descCheckList = dr["DESCRIPCION"].ToString();
                        checkList.idPlan = int.Parse(dr["IDPLAN"].ToString());
