--------------------------------------------------------
-- Archivo creado  - viernes-noviembre-01-2019   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDCHECKLISTREPORTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 122 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "NOMAS"."IDVISITA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 22 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into NOMAS.CHECKLISTREPORTE (IDCHECKREPORTE,ESTADOCHECK,FECHA,MEJORA,IDCHECKLIST) values ('108','1',to_date('01/11/19','DD/MM/RR'),'NINGUNA','61');
Insert into NOMAS.CHECKLISTREPORTE (IDCHECKREPORTE,ESTADOCHECK,FECHA,MEJORA,IDCHECKLIST) values ('109','0',to_date('01/11/19','DD/MM/RR'),'debe viajar
','62');
Insert into NOMAS.CHECKLISTREPORTE (IDCHECKREPORTE,ESTADOCHECK,FECHA,MEJORA,IDCHECKLIST) values ('106','1',to_date('01/11/19','DD/MM/RR'),'NINGUNA','63');
Insert into NOMAS.CHECKLISTREPORTE (IDCHECKREPORTE,ESTADOCHECK,FECHA,MEJORA,IDCHECKLIST) values ('107','0',to_date('01/11/19','DD/MM/RR'),'debe hacer la tarea','64');
...
IS
BEGIN
	INSERT INTO VISITA VALUES(IDVISITA.NEXTVAL,fecha_c,idPlan_c);
	COMMIT;
	EXCEPTION
	      WHEN OTHERS THEN
	          ROLLBACK;
...
BEGIN
	OPEN c_visita FOR
		SELECT vi.IDVISITA, vi.FECHA, cl.RUT AS "RUT CLIENTE", pf.RUT AS "RUT PROFESIONAL",cl.nombre||' '||cl.apepaterno AS "NOMBRE CLIENTE",
